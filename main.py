...
dataset_images_path = 'C:/Users/mjur1/Documents/Projekty_DS/photos_colorization/flickr_image_dataset/'
...
history = model.fit(image_a_b_gen(train_generator, train_transfer_learning_generator, transfer_learning_model),
                    ...
                    epochs=500,
                    steps_per_epoch=20,#round(number_of_images*0.8) // batch_size_images,
                    validation_steps=2,#round(number_of_images*0.2) // batch_size_images,
                    callbacks=callbacks)
model.save('convolution_nasnet_fusion.h5')
